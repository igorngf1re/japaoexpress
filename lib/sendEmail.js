  ...
  return {
    ...
    html: wrap(`
      ...
      <div style="text-align:center;margin-bottom:22px">
        <div style="display:inline-block;width:84px;height:84px;
                    line-height:84px;text-align:center;background:#DCFCE7;border-radius:50%;
                    font-size:38px">✅</div>
      </div>
...
function tplShipped(order) {
  ...
  return {
    ...
    html: wrap(`
      ...
      <div style="text-align:center;margin-bottom:22px">
        <div style="display:inline-block;width:84px;height:84px;
                    line-height:84px;text-align:center;background:#FEF3C7;border-radius:50%;
...
function tplOrderCreated(order) {
  ...
  return {
    ...
    html: wrap(`
      ...
      <div style="text-align:center;margin-bottom:22px">
        <div style="display:inline-block;width:84px;height:84px;
                    line-height:84px;text-align:center;background:#DBEAFE;border-radius:50%;
                    font-size:38px">🛒</div>
      </div>
