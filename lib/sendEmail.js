...
<body style="margin:0;padding:0;background-color:#E8DEF8;
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
         style="background-color:#E8DEF8;min-width:320px">
    <tr><td align="center" style="padding:32px 16px 40px">

      <!-- CARD -->
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
             style="max-width:580px;background:#FDFAF2;border-radius:22px;
                    border-top:8px solid #9B59B6;
                    box-shadow:0 8px 32px rgba(44,22,84,0.12)">

        <!-- HEADER -->
        <tr>
          <td style="padding:26px 36px 22px;border-bottom:1px solid #F0EBF8">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <span style="font-size:20px;font-weight:900;color:#2C1654;
                               letter-spacing:-0.3px">🇯🇵 Japão Express</span>
        ...
        <!-- FOOTER -->
        <tr>
          <td style="padding:20px 36px 26px;text-align:center">
    ...
    html: wrap(`
      ...
      <div style="text-align:center;margin-bottom:22px">
        <div style="display:inline-flex;align-items:center;justify-content:center;
                    width:68px;height:68px;background:#DCFCE7;border-radius:50%;
                    font-size:32px">✅</div>
      </div>
...
function tplShipped(order) {
  ...
  return {
    ...
    html: wrap(`
      ...
      <div style="text-align:center;margin-bottom:22px">
        <div style="display:inline-flex;align-items:center;justify-content:center;
                    width:68px;height:68px;background:#FEF3C7;border-radius:50%;
...
function tplOrderCreated(order) {
  ...
  return {
    ...
    html: wrap(`
      ...
      <div style="text-align:center;margin-bottom:22px">
        <div style="display:inline-flex;align-items:center;justify-content:center;
                    width:68px;height:68px;background:#DBEAFE;border-radius:50%;
                    font-size:32px">🛒</div>
      </div>
